...
public class packagetest {
  ...
  @ArchTest
  static final ArchRule classesAnotadasComEntityDeveFicarNoPacoteEnties =
      classes()
          .that()
          .areAnnotatedWith(Entity.class)
          .should()
          .resideInAPackage("..datasources..entity..")
  ...
  static final ArchRule classesAnotadasComRepositoryDeveFicarNoPacoteEnties =
      classes()
          ...
          .should()
          .resideInAPackage("..datasources..repository..")
  ...
  static final ArchRule classesAnotadasComRestControllerDeveFicarNoPacoteEnties =
      classes()
          ...
          .should()
          .resideInAPackage("..transportlayers..")
